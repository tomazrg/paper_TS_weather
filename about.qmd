...
ggsave("fig2/map_all_early.png", dpi = 600, height =10,width = 12, bg = "white")
```
...
ggsave("fig2/map_all_intermediate.png", dpi = 600, height =10,width = 12, bg = "white")
```
...
# salvar
ggsave(
  filename = "fig2/map_all_period.png",
  plot = fig_maps,
  dpi = 600,
  width = 9,
  height = 7.5,
